...
# VNC Setup Script for Codespaces (using tigervnc)
...
# Start tigervnc server directly with different display
echo "Starting tigervnc server..." >> $LOG_FILE
vncserver :1 -geometry 1024x768 -depth 24 >> $LOG_FILE 2>&1 &
sleep 3
